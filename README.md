...
### 1. `app/api/routes/health.py` - 헬스체크 엔드포인트   V
...
### 3. `docker-compose.yml` - 로컬 실행 환경    V
...
### 4. `.github/workflows/cd.yml` - CD 파이프라인   V
...
git init
      git add .
      git commit -m "feat: 과제 완성 코드"
      git branch -M main
      git remote add origin https://github.com/leegyeongwon/lumi-assignment-will-deleted.git
